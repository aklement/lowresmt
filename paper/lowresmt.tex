...
% ccb - squeezing for space
\vspace{-.15cm}
To project context vectors for Spanish to English, we use a bilingual dictionary containing entries for 49,795 Spanish words.
...
Most work on learning translations from monolingual texts only examine frequent words. \newcite{Huang2005} and \newcite{daumeiii-jagarlamudi:2011:ACL-HLT2011} are exceptions that improve MT by inducing translations for OOV words and phrases. 
