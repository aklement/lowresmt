...
Combining all three alternative phrase pair sources and performing end-to-end MT \emph{entirely without a sentence-aligned parallel corpus} results in a BLEU score of 12.65. This score is equivalent to that of training an SMT system on 100k words of bitext, and it significantly outstrips the \cite{Carbonell2006} baseline in \figref{fig:lesionreplacement}, Exp 4.
