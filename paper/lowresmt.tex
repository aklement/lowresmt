...
%There are many remaining questions and directions for future work.  It remains to be seen if increasing the amount of monolingual data that we use will afford continuous improvements, or if we need a more complex translation model. 
