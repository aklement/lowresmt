...
For all experiments, we use mnemonic labels indicating how the different sets of parameters are estimated.  The labels contain two parts, the first for the phrase-table features, the second for the reordering probabilities.  {\bf B} stands for bilingual estimation, {\bf M} stands for monolingual estimation, {\bf -} indicates omission of the parameter, and lowercase letters are the different individual monolingual similarity scores. 
