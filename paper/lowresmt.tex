...
\item Perform an ablation study in which all feature functions are dropped from from a phrase table, and then replaced with monolingually estimated equivalents.\mtodo{Don't like the word ablation.}
...
Expand to phrases.  To the best of our knowledge, this work is the first attempt to 
...
After a bilingual corpus has been word-aligned \cite{Och2003}, phrase pairs that are consistent with the word alignments are extracted using various phrase extraction heuristics \cite{Venugopal2003,Tillmann2003,Och2004}.
...
\subsection{Extracted phrase tables}\label{sect:exp:pt}
