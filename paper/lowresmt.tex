...
Much of the prior work on lexicon induction is motivated by its application to machine translation, but stops short of actually doing so.  This work is a first attempt to extend and apply these ideas to an end-to-end machine translation pipeline.
