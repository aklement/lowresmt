...
Next, we replace the feature functions with their monolingual equivalents estimated using the two sides of the bitext, hoping to regain much of the 16.4 BLEU point loss that resulted from dropping all features.  Adding orientation features estimated from monolingual data alone ({\bf --/M})  recovers 5 BLEU points. The  contextual, temporal, and orthographic monolingual features ({\bf t/--}, {\bf o/--}, and {\bf c/--}) are informative on their own and provide independent evidence for phrase similarity.  Together ({\bf M/--}), they recover over 11 BLEU points.
