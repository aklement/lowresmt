...
\newcite{ravi-knight:2011:ACL-HLT} treat MT without parallel training data as a decipherment task.  They learn a word substation cypher from monolingual texts, allowing them to translate hundreds of unique word types in time expression and subtitle text domains. Their method has not been applied to broader domains of text or full scale MT. 
